@if (session('success'))
<div class="p-4 flex items-center gap-2 text-green-800 dark:text-green-400 border-green-200 dark:border-green-900/30 bg-green-50 dark:bg-green-950/20 rounded-lg">
